...
import com.quad.project.uber.uberApp.service.AuthService;
...
import static com.quad.project.uber.uberApp.enums.Role.DRIVER;
...
public class AuthServiceImpl implements AuthService {
    ...
    public UserDto signup(SignupDto signupDto) {
        ...
        if(user != null){
            throw new RuntimeConflictException("Cannot signup, User with already exist with email "+signupDto.getEmail());
        }
    ...
    public DriverDto onboardNewDriver(Long userId, String vehicleId) {
        ...
        if (user.getRoles().contains(DRIVER)) throw new RuntimeException("User with id : " +userId +"is already a Driver");
